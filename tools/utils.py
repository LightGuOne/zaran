...
pinyin_table = read_tsv_many(os.path.join(pyPath,'data','chars.txt'), 0, 1)
freq_trad_table = read_tsv(os.path.join(pyPath,'data','chars.txt'), (0, 1), 2)
freq_simp_table = read_tsv(os.path.join(pyPath,'data','chars.txt'), (0, 1), 3)
chai_table = read_tsv(os.path.join(pyPath,'data','moran_chai.txt'), (0, 1), 2)
aux_table = read_tsv_many(os.path.join(pyPath,'data','moran_chai.txt'), 0, 1)
...
def get_chars_version():
    chaidate = get_modified_date(os.path.join(pyPath,'data','moran_chai.txt'))
    charsdate = get_modified_date(os.path.join(pyPath,'data','chars.txt'))
